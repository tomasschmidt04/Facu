...
def main():
    ...
    consultaSQL = """
                    Select DISTINCT Sexo #El DISTINCT ELIMINA FILAS REPETIDAS*COMO EN LOGICA RELACIONAL()
                    from empleado
...
def imprimirEjercicio(consigna, listaDeDataframesDeEntrada, consultaSQL):
    ...
    print("# Salida:")
    print("# -------")
    print(sql^ consultaSQL) #CONSULTA APLICADA AL DF, es como que se aplica el string 
    print()
    print("# -----------------------------------------------------------------------------")
    print("# -----------------------------------------------------------------------------")
    print()
